      ...
      <div className="bg-white overflow-hidden w-full mx-auto relative">
        ...
        <header className="w-full h-16 md:h-20 lg:h-[120px] relative bg-white flex items-center justify-between px-4 md:px-6 lg:px-[106px]">
          ...
          <div className="flex items-center space-x-2 md:space-x-3 xl:space-x-4 order-3">
            {/* Shopping Bag Icon */}
            <div className="relative w-8 h-8 md:w-10 md:h-10 xl:w-11 xl:h-[43px] bg-[#eeeeee] rounded-full xl:rounded-[22px] flex items-center justify-center">
              <img
                src="https://img.icons8.com/?size=100&id=3686&format=png&color=000000"
                alt="Shopping Bag"
                className="w-4 h-4 md:w-5 md:h-5 xl:w-[21px] xl:h-[21px]"
              />
              {cartItems.length > 0 && (
            ...
            <button className="hidden xl:block h-10 xl:h-12 bg-[#ff2c6a] rounded-[26px] px-4 xl:px-6 font-['Poppins',sans-serif] font-medium text-white text-lg xl:text-xl hover:bg-[#e6245e] transition-colors">
              Try Racan
            </button>

            {/* Profile Image - Desktop Only */}
            <img
              className="hidden xl:block w-12 xl:w-[58px] h-12 xl:h-14 object-cover rounded-full"
              alt="User Profile"
        ...
        {/* Mobile Menu Overlay */}
        {isMenuOpen && (
          <div className="xl:hidden fixed inset-0 bg-white z-40 pt-20">
        ...
        <section className="w-full mt-12 sm:mt-16 md:mt-20 lg:mt-[98px] bg-[#9fead33b] py-8 sm:py-12 md:py-16 lg:py-[76px]">
          <div className="px-4 md:px-8 lg:px-[95px]">
            <div className="flex flex-col lg:flex-row items-start mb-8 md:mb-12 lg:mb-[76px]">
              <h2 className="font-['Spline_Sans_Mono',monospace] font-medium text-[#363535] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[64px] leading-tight max-w-full lg:max-w-[650px] mb-4 lg:mb-0">
        ...
        <section className="w-full h-48 sm:h-64 md:h-80 lg:h-[637px] bg-[url('https://images.pexels.com/photos/8532635/pexels-photo-8532635.jpeg?auto=compress&cs=tinysrgb&w=1000')] bg-cover bg-center relative">
          <h2 className="absolute w-full max-w-[280px] sm:max-w-xs md:max-w-md lg:max-w-[510px] top-1/2 transform -translate-y-1/2 left-4 md:left-8 lg:left-[92px] font-['Shinko_Sans-Regular',sans-serif] font-normal text-black text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[64px] leading-tight">
